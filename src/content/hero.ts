...
export const memo = {
  ...
  pinto: [
    ...
    'The Ford Pinto had a rear-mounted fuel tank that was prone to rupture in rear-end collisions. In the litigation that followed, an internal cost-benefit memorandum surfaced in which the company appeared to weigh the projected cost of settling burn-death claims against the per-unit cost of a safer tank.',
