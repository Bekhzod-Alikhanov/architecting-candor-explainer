...
export interface Principle {
  ...
  /** Paragraphs. These were single 56-67 word blocks and are the densest
      reading on the site, so they are split rather than set as one wall. */
...
export const principles: readonly Principle[] = [
  ...
  },
  {
    ...
    body: [
      'Authentic candour depends on predictable limits on adverse use, a principle the Supreme Court has long treated as a prerequisite to the attorney-client privilege itself.',
      'Because liability exposure is the driving force behind suppression, the act of reporting through the authorised process cannot itself supply prima facie evidence of a defect or of negligence in design.',
    ],
  ...
  },
  {
    ...
    body: [
      'Just as the healthcare model leaves original medical records discoverable, the raw factual telemetry collected in the first channel should remain reachable by injured parties and by regulators.',
      'This is not a concession the design tolerates; it is the condition that makes the rest of it legitimate, and the reason a firm can credibly say its privileged channel holds judgment rather than concealed facts.',
    ],
  },
  {
    n: '04',
    ...
    body: [
      'The receiving organization should de-identify submissions, aggregate cross-firm patterns, issue urgent hazard notices where warranted, share pattern-level findings with participating firms and government safety authorities, and publish periodic findings.',
      'That obligation turns each firm’s private learning into an industry-wide safety commons, which no market incentive produces on its own, and it anchors the statute in the separation of recipient from enforcer on which every analog regime rests.',
    ],
  },
]
