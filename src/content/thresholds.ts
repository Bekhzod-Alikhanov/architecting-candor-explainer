...
export const calibrateArgues = {
  ...
  body: [
    ...
    'A threshold defined before any harm-framed record exists supplies contemporaneous timing and separation. That is the difference between a privilege claim a court reads as pre-committed and one it reads as a reactive assertion made after the firm knew it had a problem.',
  ],
} as const
